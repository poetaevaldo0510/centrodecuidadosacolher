...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-50 bg-[#25D366] hover:bg-[#20BA5C] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 group"
